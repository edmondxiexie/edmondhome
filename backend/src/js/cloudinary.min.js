!(function(e) {
  ...
  var s = function(u, s) {
    ...
    var v = function() {
        m.cloud_name || (m.cloud_name = e),
          !m.api_key && t && (m.api_key = t),
          (m.secure = m.secure || "https:" === document.location.protocol),
          (m.requireSignature = !!m.upload_signature);
        (function() {
          for (
            var e = !!m.upload_signature,
              t = e
                ? ["api_key", "cloud_name"]
        ...
        a && n.push("debug=true"),
          d && n.push("dev=true"),
          w && n.push("inline=true"),
          m.cloud_name && n.push("cloud_name=" + m.cloud_name),
          (f =
            m.widgetHost ||
            i +
              "//widget.cloudinary.com/n/" +
              m.cloud_name +
              "/" +
              o +
              "/index.html"),
          g.setAttribute("src", f + "?" + n.join("&")),
          g.setAttribute("width", "100%"),
          g.setAttribute("height", "100%"),
          g.setAttribute("frameborder", "no"),
          g.setAttribute("allow", "camera"),
          ...
          x(g, "load", function() {
            A("init", m),
              (I = !0),
              h && ((g.style.display = "block"), g.focus(), A("open", {}));
          }),
          x(window, "message", _);
        var r = function() {
        ...
        l.appendChild(g),
          w ||
            x(window.document, "keyup", function(e) {
              27 == e.keyCode && S();
            }),
          y && k();
      },
      k = function() {
        ...
        e.setAttribute("class", m.button_class || "cloudinary-button"),
          e.setAttribute("href", "#"),
          (e.innerHTML = m.button_caption || "Upload image"),
          y.parentNode.insertBefore(e, y.previousSibling),
          ...
          !m.field_name &&
            y.getAttribute("name") &&
            "" != y.getAttribute("name") &&
            (m.field_name = y.getAttribute("name"));
      },
      x = function(e, t, i) {
        e.addEventListener
      ...
      C = function(e) {
        (h = !0),
          (p = window.document.body.style.overflow),
          w || (window.document.body.style.overflow = "hidden"),
          I && ((g.style.display = "block"), g.focus(), A("open", e || {}));
      },
      _ = function(e) {
          ...
          if (t.widget_id == b)
            switch (t.kind) {
              case "fileuploadsuccess":
                i &&
                  i(y || m.form || document).trigger(
                    "cloudinarywidgetfileuploadsuccess",
                    [t.result]
                  );
                break;
              case "success":
                m.keep_widget_open || w || S(),
                  M(t.result),
                  s && s(null, t.result),
                  i &&
                    i(y || m.form || document).trigger(
                      "cloudinarywidgetsuccess",
                      [t.result]
                    );
                break;
              case "fileuploadfail":
              ...
              case "error":
                m.keep_widget_open || w || S(),
                  ...
                  i &&
                    i(y || m.form || document).trigger(
                      "cloudinarywidgeterror",
                      t
                    );
                break;
              case "closed":
                S();
                var n = { message: "User closed widget" };
                s && s(n),
                  i &&
                    i(y || m.form || document).trigger(
                      "cloudinarywidgetclosed",
                      n
                    );
                break;
              case "get-signature":
                var o = m.upload_signature;
                if ("string" == typeof o) A("signature", { signature: o });
      ...
      S = function() {
        (g.style.display = "none"),
          (window.document.body.style.overflow = p),
          (h = !1);
      },
      M = function(e) {
        if (i) {
          ...
          if (
            (t &&
              ...
              i.each(e, function(e, o) {
                var a =
                  [o.resource_type, o.type, o.path].join("/") +
                  "#" +
                  o.signature;
                i("<input />")
                  .addClass("cloudinary-hidden-field")
                  .attr({
                    type: "hidden",
                    name: n,
            ...
            i.each(e, function(e, t) {
              var n = i("<li></li>")
                .addClass("cloudinary-thumbnail")
                .data("cloudinary", t);
              t.thumbnail_url
                ? n.append(i("<img />").attr("src", t.thumbnail_url))
                : n.append(i("<span></span>").text(t.public_id)),
                t.delete_token &&
                  n.append(
                    i("<a></a>")
                      .addClass("cloudinary-delete")
                      .attr("href", "#")
                      .text("Ã—")
                  ),
              ...
              o.find("li").length > 0 &&
                (m.thumbnails ? i(m.thumbnails).append(o) : i(y).after(o)),
              o.find(".cloudinary-delete").click(function(e) {
                e.preventDefault();
                var o = i(this)
                    .parents(".cloudinary-thumbnail")
                    .data("cloudinary"),
                  a = Z(o.delete_token);
                if (
                  (a &&
                  ...
                  var d = i(t).find(
                    'input[name="' +
                      ...
                      o.public_id +
                      '"].cloudinary-hidden-field'
                  );
                  i(t).find('input[name="' + n + '"].cloudinary-hidden-field')
                    .length > 1
                    ? i(d).remove()
                    : i(d)
                        .attr("data-cloudinary-public-id", "")
                        .val("")
  ...
  (window.cloudinary = window.cloudinary || {}),
    ...
    i &&
      (i.fn.cloudinary_upload_widget = function(e, t) {
